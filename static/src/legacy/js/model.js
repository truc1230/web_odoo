odoo.define("web.Model", function (require) {
    ...
    class ModelExtension {
         ...
         */
        constructor(config) {
            console.log("🚀 ~ file: model.js ~ line 21 ~ ModelExtension ~ constructor ~ config", config)
            this.config = config;
            console.log("🚀 ~ file: model.js ~ line 23 ~ ModelExtension ~ constructor ~ this", this)
    ...
    class Model extends EventBus {
        ...
        constructor(extensions = {}, globalConfig = {}) {
            ...
            console.log("🚀 ~ file: model.js ~ line 233 ~ Model ~ constructor ~ globalConfig", globalConfig)
            this.env = this.config.env;
    ...
    function useModel(modelName) {
        ...
        console.log("🚀 ~ file: model.js ~ line 457 ~ useModel ~ component", component)
        const model = component.env[modelName];
        console.log("🚀 ~ file: model.js ~ line 459 ~ useModel ~ modelName", modelName)
